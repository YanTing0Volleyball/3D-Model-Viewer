...
public:
	...
	bool LoadMtlFile(const std::string& filePath, const std::string& folderPath);
...
private:
	...
	// Material Map For Mapping Material Flag to PhongMaterial Data
	std::map<std::string, PhongMaterial> materialMap;
